...
- [ ] T002 Verify existing project structure matches plan expectations (server/, client/, package.json)
...
- [ ] T028 [US3] Update project create mutation in UI to include `ruflo_prompt` and `openclaw_prompt` in payload in client/src/components/ProjectDashboard.tsx
- [ ] T029 [US3] Update project edit mutation to include `ruflo_prompt` and `openclaw_prompt` in payload in client/src/components/ProjectDashboard.tsx
...
- [ ] T040 [P] [US7] Create `SessionBadges` component displaying source, executor, and lock badges in client/src/components/SessionBadges.tsx
- [ ] T041 [US7] Integrate `SessionBadges` into session list cards — read `requested_by`, `cli_type`, `write_capable` from session data in client/src/components/SessionCard.tsx
- [ ] T042 [US7] Integrate `SessionBadges` into session detail view in client/src/pages/SessionDetail.tsx
- [ ] T043 [US7] Add session metadata display (requested_by, controller_kind, lock_key, prompt_context) to session detail view in client/src/pages/SessionDetail.tsx
...
- [ ] T044 [P] [US8] Create `OpenClawIntegrationPanel` component with project context, prompt config status, lock status, and recommended skill command in client/src/components/OpenClawIntegrationPanel.tsx
- [ ] T045 [US8] Replace `AgentGuideModal` trigger in `SessionLauncher.tsx` with `OpenClawIntegrationPanel` as primary "Run with OpenClaw" action in client/src/components/SessionLauncher.tsx
- [ ] T046 [US8] Preserve old guide modal as hidden "Developer fallback" secondary action in client/src/components/SessionLauncher.tsx
- [ ] T047 [US8] Display active OpenClaw-controlled sessions and lock owner in the integration panel in client/src/components/OpenClawIntegrationPanel.tsx
...
- [ ] T051 [P] Remove any client-side prompt composition that duplicates server-side composition in client/src/components/SessionLauncher.tsx
